...
MatrixXd Tucker::Unfolding(const Tensor<double, 3>& tensor, int k) const
{
...
Tensor<double, 3> Tucker::Folding(int I0, int I1, int I2, const MatrixXd& unfolding, int k) const
{
